...
export function computeNoAnswerCount(logs: { contact_status: string }[]): number {
  ...
  for (const log of logs) {
    // A connection, callback, negative, or a successful message touch ends the streak.
    if (['answered', 'call_back_later', 'message_sent', 'negative'].includes(log.contact_status)) break;
